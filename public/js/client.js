...
/*
validField(/^[a-zA-Z ]+$/, data.name, 'Nome inválido, use somente letras sem acentos!') &&
validField(/^[0-9][0-9][0-9].[0-9][0-9][0-9].[0-9][0-9][0-9]-[0-9][0-9]*$/, data.cpf, "CPF inválido!") &&
validField(/^[a-zA-Z ]+$/, data.country, 'País inválido, use somente letras sem acentos!') &&
validField(/^[A-Z][A-Z]+$/, data.state, 'Estado inválido, use somente acrônimos, ex: SC, RS, SP, PR!') &&
validField(/^[a-zA-Z ]+$/, data.city, 'Cidade inválida, use somente letras sem acentos!') &&
validField(/^\([0-9][0-9]\) [0-9][0-9][0-9][0-9]\-[0-9][0-9][0-9][0-9]*$/, data.phoneOne, "Telefone inválido") &&
validField(/^\([0-9][0-9]\) [0-9][0-9][0-9][0-9]\-[0-9][0-9][0-9][0-9]*$/, data.phoneTwo, "Telefone inválido") &&
validField(/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/, data.email, "Email inválido")
*/